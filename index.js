...
const displayStr = `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} games. Currently, ${numberOfUnfundedGames} game${numberOfUnfundedGames === 1 ? '' : 's'} remain unfunded. We need your help to fund these amazing games!`;
...
firstGameElement.innerText = `Top Game: ${firstGame.name}`;
...
// An added feature to search games by name
